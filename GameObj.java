...
public abstract class GameObj {
    ...
    public void mazeWall(Direction d) {
    	if (d == null) return;
    ...
    public Direction checkMaze(Maze mazeLayout){
    	Maze.Squares[][] maze = mazeLayout.getMaze();
    	int xFuture = (int) (this.px + this.vx) / 30;
    	int yFuture = (int) (this.py + this.vy) / 30;
    	int widthInc = (int) (this.px + this.vx + this.width) / 30;
    	int heightInc = (int) (this.py + this.vy + this.height) / 30;
    	if(xFuture >= 10 || widthInc >= 10){
    		xFuture = (int) ((this.maxX) / 30) ;
    		widthInc = xFuture;
    	}
    	if(yFuture >= 10 || heightInc >= 10 ){
    		yFuture = (int) ((this.maxY) / 30);
    		heightInc = yFuture;
    	}
    	
    	
    	
    	if((maze[xFuture][yFuture].getColor().equals(Color.BLUE) || 
    			maze[xFuture][heightInc].getColor().equals(Color.BLUE)) && this.vx < 0){
    		return Direction.LEFT;
    	}
    	else if((maze[widthInc][yFuture].getColor().equals(Color.BLUE) || 
    			maze[widthInc][heightInc].getColor().equals(Color.BLUE) ) && this.vx > 0){
    		return Direction.RIGHT;
    	}
    	else if((maze[xFuture][yFuture].getColor().equals(Color.BLUE) || 
    			maze[widthInc][yFuture].getColor().equals(Color.BLUE)) && this.vy < 0){
    		return Direction.UP;
    	}
    	else if((maze[xFuture][heightInc].getColor().equals(Color.BLUE) || 
    			maze[widthInc][heightInc].getColor().equals(Color.BLUE)) && this.vy > 0){
